package com.example.hw11.command.move;

import static com.example.hw11.TestUtils.clearSpaceshipObject;
...
import com.example.hw11.command.operations.move.MoveNonLinearCommand;
...
class MoveNonLinearCommandTest extends IoCAbstractTest {
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoVelocity() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw11.command.operations.ChangeVelocityVectorCommand"))
        );
    }
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoDirection() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw11.command.operations.RotateCommand"))
        );
    }
}
