package com.example.hw7.command.move;

import static com.example.hw7.TestUtils.clearSpaceshipObject;
...
import com.example.hw7.IoCAbstractTest;
import com.example.hw7.command.log.LogErrorCommand;
import com.example.hw7.command.operations.move.MoveNonLinearCommand;
...
class MoveNonLinearCommandTest extends IoCAbstractTest {
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoVelocity() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw7.command.operations.ChangeVelocityVectorCommand"))
        );
    }
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoDirection() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw7.command.operations.RotateCommand"))
        );
    }
}
