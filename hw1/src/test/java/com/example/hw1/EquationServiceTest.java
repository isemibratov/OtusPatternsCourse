...
public class EquationServiceTest {
    ...
    public void shouldSolveWithNoSolutions_aEq1_bEq0_cEq1() {
        // when
        double[] solution = equationService.solve(1, 0, 1);
    ...
    public void shouldSolveWithSolutions_aEq1_bEq2_cEqNeg1() {
        // when
        double[] solution = equationService.solve(1, 2, 1);
    ...
    public void shouldThrowExceptionWhen_aEq0() {
        // when+then
        assertThrows(IllegalArgumentException.class, () -> equationService.solve(0, 2, 1));
    }
}
