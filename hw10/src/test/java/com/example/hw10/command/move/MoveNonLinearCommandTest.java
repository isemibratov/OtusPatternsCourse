package com.example.hw10.command.move;

import static com.example.hw10.TestUtils.clearSpaceshipObject;
...
import com.example.hw10.IoCAbstractTest;
import com.example.hw10.command.log.LogErrorCommand;
import com.example.hw10.command.operations.move.MoveNonLinearCommand;
...
class MoveNonLinearCommandTest extends IoCAbstractTest {
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoVelocity() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw10.command.operations.ChangeVelocityVectorCommand"))
        );
    }
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoDirection() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw10.command.operations.RotateCommand"))
        );
    }
}
