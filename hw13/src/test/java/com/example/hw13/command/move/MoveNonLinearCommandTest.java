package com.example.hw13.command.move;

import static com.example.hw13.TestUtils.clearSpaceshipObject;
...
import com.example.hw13.command.operations.move.MoveNonLinearCommand;
...
class MoveNonLinearCommandTest extends IoCAbstractTest {
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoVelocity() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw13.command.operations.ChangeVelocityVectorCommand"))
        );
    }
    ...
    void shouldThrowExceptionWhenMoveSpaceshipWithNoDirection() {
        ...
        assertAll(
                ...
                () -> assertTrue(logs.get(0).toString().contains("Error in operation: com.example.hw13.command.operations.RotateCommand"))
        );
    }
}
