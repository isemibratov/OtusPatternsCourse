...
import com.example.hw13.command.exception.DefaultHandleExceptionCommand;
import com.example.hw13.command.exception.LogErrorExceptionCommand;
import com.example.hw13.command.exception.QueueEnrichExceptionCommand;
import com.example.hw13.command.exception.ThrowExceptionCommand;
import com.example.hw13.command.log.LogQueueSizeCommand;
import com.example.hw13.command.order.CheckOrderCommand;
...
public abstract class ExceptionHandlerCommandFactory {
    ...
    private static void initialize() {
        ...
        commands.put(
                CheckOrderCommand.class.getName(),
                CommandException.class.getName(),
                () -> setExceptionCommand(new ThrowExceptionCommand(CheckOrderCommand.class.getSimpleName(), exceptionVal)));
    }
